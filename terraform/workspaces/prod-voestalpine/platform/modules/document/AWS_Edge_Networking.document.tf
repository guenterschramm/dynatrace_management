  ...
  content   = jsonencode({
      ...
      "tiles": {
        ...
        "34": {
          ...
          "query": "timeseries downloaded = avg(cloud.aws.cloudfront.BytesDownloaded.By.DistributionId.Region),\n            by: {DistributionId, aws.account.id, dt.smartscape_source.id},\n            filter:{in(aws.account.id, array($AccountId)) AND\n                    in(dt.smartscape_source.id, iCollectArray(toSmartscapeId(array($CloudfrontSmartscapeId)[])))}\n| sort arraySum(downloaded) desc\n| limit toLong($Limit)",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
        ...
        "39": {
          ...
          "title": "Total average connection time",
          "type": "data",
          "visualization": "singleValue",
          "visualizationSettings": {
            "autoSelectVisualization": false,
        ...
        "40": {
          ...
          "title": "Total average time to first byte",
          "type": "data",
          "visualization": "singleValue",
          "visualizationSettings": {
            "autoSelectVisualization": false,
