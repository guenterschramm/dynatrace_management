  ...
  content   = jsonencode({
      ...
      "tiles": {
        ...
        "43": {
          ...
          "query": "timeseries max = max(cloud.azure.microsoft_app.containerapps.RxBytes),\n            by: {azure.resource.name, azure.subscription, azure.location, dt.smartscape_source.id}\n| fieldsAdd lastMaxCPU = arrayMax(max)\n| sort lastMaxCPU desc\n| limit 100",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
        ...
        "5": {
          ...
          "query": "timeseries max = max(cloud.azure.microsoft_compute.virtualmachines.NetworkInTotal),\n            by: {azure.resource.name, azure.subscription, azure.location, dt.smartscape_source.id}\n| sort arrayMax(max) desc\n| limit 10",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
        ...
        "53": {
          ...
          "query": "timeseries max = max(cloud.azure.microsoft_compute.virtualmachinescalesets.NetworkInTotal),\n            by: {azure.resource.name, azure.subscription, azure.location, dt.smartscape_source.id}\n| fieldsAdd lastMaxCPU = arrayMax(max)\n| sort lastMaxCPU desc\n| limit 100",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
        ...
        "6": {
          ...
          "query": "timeseries max = max(cloud.azure.microsoft_compute.virtualmachines.NetworkOutTotal),\n            by: {azure.resource.name, azure.subscription, azure.location, dt.smartscape_source.id}\n| sort arrayMax(max) desc\n| limit 10",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
