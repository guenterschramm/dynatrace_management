resource "dynatrace_hub_extension_v2_config" "com_dynatrace_ext_sap_3" {
  name  = "com.dynatrace.ext.sap"
  scope = "ag_group-default"
  value = jsonencode({
      "activationContext": "REMOTE",
      "description": "SAP_ERP_VQR",
      "enabled": false,
      "featureSets": [
        "Job Metrics",
        "Task Metrics",
      ...
      "pythonRemote": {
        ...
        "debug": false,
        "instance": "31",
        "password": "***392251a0e07525f9***",
        "pollAll": false,
        "pollLess": false,
        "rfc": "Per function call",
        "rum": true,
        "server": "Vadsvqr31.voestalpine.root.local",
        "tasks": [],
        "timeoutMin": 25,
        "useHostName": true,
