resource "dynatrace_metric_query" "metric-func_slo_normalizedErrorBudget_sap_gui_network_time_hourly" {
  metric_id       = "metric-func:slo.normalizedErrorBudget.sap_gui_network_time_hourly"
  metric_selector =<<-EOT
