resource "dynatrace_metric_query" "metric-func_slo_errorBudget_sap_gui_network_time_hourly" {
  metric_id       = "metric-func:slo.errorBudget.sap_gui_network_time_hourly"
  metric_selector =<<-EOT
