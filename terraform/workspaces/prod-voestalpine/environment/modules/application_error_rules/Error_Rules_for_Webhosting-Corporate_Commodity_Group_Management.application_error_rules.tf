resource "dynatrace_application_error_rules" "Error_Rules_for_Webhosting-Corporate_Commodity_Group_Management" {
  # ignore_custom_errors_apdex = false
  # ignore_http_errors_apdex   = false
  # ignore_js_errors_apdex     = false
  web_application_id           = "APPLICATION-0D2E39FAC87814BC"
  custom_errors {
    rule {
      capture         = true
