resource "dynatrace_json_dashboard" "xECM_P_Steel-OTCS_Service_key_requests_owned_by_Dietmar_Wallner_voestalpine_com" {
  contents = jsonencode({
      "dashboardMetadata": {
        "dashboardFilter": {
          "timeframe": "-24h to now"
        },
        "name": "xECM P (Steel) - OTCS Service key requests",
  ...
  link_id  = "${dynatrace_json_dashboard_base.xECM_P_Steel-OTCS_Service_key_requests_owned_by_Dietmar_Wallner_voestalpine_com.id}"
}


resource "dynatrace_dashboard_sharing" "xECM_P_Steel-OTCS_Service_key_requests_owned_by_Dietmar_Wallner_voestalpine_com" {
  enabled      = true
  dashboard_id = "${dynatrace_json_dashboard_base.xECM_P_Steel-OTCS_Service_key_requests_owned_by_Dietmar_Wallner_voestalpine_com.id}"
  preset       = true
  permissions {
    permission {
      type  = "ALL"
...
resource "dynatrace_json_dashboard_base" "xECM_P_Steel-OTCS_Service_key_requests_owned_by_Dietmar_Wallner_voestalpine_com" {
  # contents = ""
}
