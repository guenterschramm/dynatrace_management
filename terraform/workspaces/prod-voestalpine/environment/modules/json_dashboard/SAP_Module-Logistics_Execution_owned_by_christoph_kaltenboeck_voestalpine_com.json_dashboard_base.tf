resource "dynatrace_json_dashboard" "SAP_Module-Logistics_Execution_owned_by_christoph_kaltenboeck_voestalpine_com" {
  contents = jsonencode({
      "dashboardMetadata": {
  ...
  link_id  = "${dynatrace_json_dashboard_base.SAP_Module-Logistics_Execution_owned_by_christoph_kaltenboeck_voestalpine_com.id}"
}


resource "dynatrace_dashboard_sharing" "SAP_Module-Logistics_Execution_owned_by_christoph_kaltenboeck_voestalpine_com" {
  enabled      = true
  dashboard_id = "${dynatrace_json_dashboard_base.SAP_Module-Logistics_Execution_owned_by_christoph_kaltenboeck_voestalpine_com.id}"
  # preset     = false
  permissions {
    permission {
      type  = "ALL"
...
resource "dynatrace_json_dashboard_base" "SAP_Module-Logistics_Execution_owned_by_christoph_kaltenboeck_voestalpine_com" {
  # contents = ""
}
