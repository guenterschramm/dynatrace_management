resource "dynatrace_json_dashboard" "SAP_Module-Cross_Application_Basis_Components_owned_by_christoph_kaltenboeck_voestalpine_com_1" {
  contents = jsonencode({
      "dashboardMetadata": {
  ...
  link_id  = "${dynatrace_json_dashboard_base.SAP_Module-Cross_Application_Basis_Components_owned_by_christoph_kaltenboeck_voestalpine_com_1.id}"
}


resource "dynatrace_dashboard_sharing" "SAP_Module-Cross_Application_Basis_Components_owned_by_christoph_kaltenboeck_voestalpine_com_1" {
  enabled      = true
  dashboard_id = "${dynatrace_json_dashboard_base.SAP_Module-Cross_Application_Basis_Components_owned_by_christoph_kaltenboeck_voestalpine_com_1.id}"
  # preset     = false
  permissions {
    permission {
      type  = "ALL"
...
resource "dynatrace_json_dashboard_base" "SAP_Module-Cross_Application_Basis_Components_owned_by_christoph_kaltenboeck_voestalpine_com_1" {
  # contents = ""
}
