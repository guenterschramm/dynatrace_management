resource "dynatrace_metric_events" "High_outbound_bandwidth_utilization_1" {
  enabled                    = false
  ...
  query_definition {
    ...
    metric_selector = "func:com.dynatrace.extension.snmp-generic-cisco-device.if.out.bandwidth"
  }
}
