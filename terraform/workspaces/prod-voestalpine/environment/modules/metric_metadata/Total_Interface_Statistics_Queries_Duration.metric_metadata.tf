resource "dynatrace_metric_metadata" "Total_Interface_Statistics_Queries_Duration" {
  description  = "Total duration of all paged queries, used to collect interface metrics."
  display_name = "Total Interface Statistics Queries Duration"
  metric_id    = "metric-sfm.cisco.cc.endpoint.fetch_ifaces_statistics.duration"
  unit         = "Seconds"
  dimensions {
    dimension {
