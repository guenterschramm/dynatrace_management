resource "dynatrace_metric_metadata" "Interface_Discovery_Data_Query_Duration" {
  ...
  display_name = "Interface Discovery Data Query Duration"
  metric_id    = "metric-sfm.cisco.cc.devices.get_all_interfaces.duration"
  unit         = "Seconds"
  dimensions {
    dimension {
