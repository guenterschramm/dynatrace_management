resource "dynatrace_metric_metadata" "Interface_Count" {
  description        = "Total Number of Interfaces for Device"
  display_name       = "Interface Count"
  metric_id          = "metric-cisco.cc.device.total_interface_count.gauge"
