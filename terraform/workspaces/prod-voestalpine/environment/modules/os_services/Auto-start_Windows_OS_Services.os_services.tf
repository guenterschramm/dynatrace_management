resource "dynatrace_os_services" "Auto-start_Windows_OS_Services" {
  ...
  enabled                   = false
  alert_activation_duration = 3
  alerting                  = true
  insert_after              = "vu9U3hXa3q0AAAABAB5idWlsdGluOm9zLXNlcnZpY2VzLW1vbml0b3JpbmcABnRlbmFudAAGdGVuYW50ACQ4N2QwNzA3MC04ZTg1LTM2ODgtOWYwOC1mYWU2YWNiMjAxNDa-71TeFdrerQ"
  monitoring                = false
