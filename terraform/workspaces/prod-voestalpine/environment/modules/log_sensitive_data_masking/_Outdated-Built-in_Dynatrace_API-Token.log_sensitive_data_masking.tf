resource "dynatrace_log_sensitive_data_masking" "_Outdated-Built-in_Dynatrace_API-Token" {
  ...
  enabled      = true
  insert_after = "vu9U3hXa3q0AAAABADVidWlsdGluOmxvZ21vbml0b3Jpbmcuc2Vuc2l0aXZlLWRhdGEtbWFza2luZy1zZXR0aW5ncwAGdGVuYW50AAZ0ZW5hbnQAJDM2NWY3ZmUwLWU0YjctMzQ4Ni1hYTYyLTJiNWJjMTgxZjA5Ob7vVN4V2t6t"
  scope        = "environment"
  masking {
    type        = "STRING"
