resource "dynatrace_browser_monitor" "q-ecm-steel_voestalpine_net_Test_DW" {
  ...
  script {
    ...
    events {
      event {
        description = "Loading of \"https://q-ecm-steel.voestalpine.net/\""
        navigate {
          url = "https://q-ecm-steel.voestalpine.net/"
          wait {
