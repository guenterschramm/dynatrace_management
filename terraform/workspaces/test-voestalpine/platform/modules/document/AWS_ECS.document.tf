  ...
  content   = jsonencode({
      ...
      "tiles": {
        ...
        "11": {
          ...
          "description": "",
          "query": "timeseries x=sum(cloud.aws.ecs_containerinsights.NetworkRxBytes.By.ClusterName),\n           filter:{in(aws.account.id, array($AccountId)) AND\n                   in(aws.region, array($Region)) AND\n                   in(dt.smartscape_source.id, iCollectArray(toSmartscapeId(array($SmartscapeId)[])))} ,\n           nonempty:true\n\n| fieldsAdd y = arrayAvg(x)\n| summarize y = sum(y)",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
        ...
        "12": {
          ...
          "description": "",
          "query": "timeseries x=sum(cloud.aws.ecs_containerinsights.NetworkTxBytes.By.ClusterName),\n           filter:{in(aws.account.id, array($AccountId)) AND\n                   in(aws.region, array($Region)) AND\n                   in(dt.smartscape_source.id, iCollectArray(toSmartscapeId(array($SmartscapeId)[])))},\n           nonempty:true\n\n| fieldsAdd y = arrayAvg(x)\n| summarize y = sum(y)",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
        ...
        "3": {
          ...
          "description": "",
          "query": "timeseries x=avg(cloud.aws.ecs_containerinsights.MemoryUtilized.By.ClusterName),\n           filter:{in(aws.account.id, array($AccountId)) AND\n                   in(aws.region, array($Region)) AND\n                   in(dt.smartscape_source.id, iCollectArray(toSmartscapeId(array($SmartscapeId)[])))} ,\n           nonempty:true\n\n| fieldsAdd y = arrayAvg(x)\n| summarize y = avg(y)",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
        ...
        "35": {
          ...
          "description": "",
          "query": "timeseries y=avg(cloud.aws.ecs_containerinsights.EphemeralStorageReserved.By.ClusterName),\n           by: {ClusterName, aws.account.id, aws.region, dt.smartscape_source.id},\n           filter:{in(aws.account.id, array($AccountId)) AND\n                   in(aws.region, array($Region)) AND\n                   in(dt.smartscape_source.id, iCollectArray(toSmartscapeId(array($SmartscapeId)[])))}\n\n| fieldsAdd x = arrayLast(y)\n| sort x desc\n| limit toLong($Limit)",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
        ...
        "36": {
          ...
          "description": "",
          "query": "timeseries y=avg(cloud.aws.ecs_containerinsights.EphemeralStorageUtilized.By.ClusterName),\n           by: {ClusterName, aws.account.id, aws.region, dt.smartscape_source.id},\n           filter:{in(aws.account.id, array($AccountId)) AND\n                   in(aws.region, array($Region)) AND\n                   in(dt.smartscape_source.id, iCollectArray(toSmartscapeId(array($SmartscapeId)[])))}\n\n| fieldsAdd x = arrayLast(y)\n| sort x desc\n| limit toLong($Limit)",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
        ...
        "37": {
          ...
          "description": "",
          "query": "timeseries x=avg(cloud.aws.ecs_containerinsights.EphemeralStorageUtilized.By.ClusterName),\n           filter:{in(aws.account.id, array($AccountId)) AND\n                   in(aws.region, array($Region)) AND\n                   in(dt.smartscape_source.id, iCollectArray(toSmartscapeId(array($SmartscapeId)[])))},\n           nonempty:true\n\n| fieldsAdd y = arrayAvg(x)\n| summarize y = avg(y)",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
        ...
        "38": {
          ...
          "description": "",
          "query": "timeseries x=avg(cloud.aws.ecs_containerinsights.EphemeralStorageReserved.By.ClusterName),\n           filter:{in(aws.account.id, array($AccountId)) AND\n                   in(aws.region, array($Region)) AND\n                   in(dt.smartscape_source.id, iCollectArray(toSmartscapeId(array($SmartscapeId)[])))},\n           nonempty:true\n\n| fieldsAdd y = arrayAvg(x)\n| summarize y = avg(y)",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
        ...
        "4": {
          ...
          "description": "",
          "query": "timeseries x=avg(cloud.aws.ecs_containerinsights.MemoryReserved.By.ClusterName),\n           filter:{in(aws.account.id, array($AccountId)) AND\n                   in(aws.region, array($Region)) AND\n                   in(dt.smartscape_source.id, iCollectArray(toSmartscapeId(array($SmartscapeId)[])))} ,\n           nonempty:true\n\n| fieldsAdd y = arrayAvg(x)\n| summarize y = avg(y)",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
        ...
        "7": {
          ...
          "description": "",
          "query": "timeseries y=avg(cloud.aws.ecs_containerinsights.MemoryUtilized.By.ClusterName),\n           by: {ClusterName, aws.account.id, aws.region, dt.smartscape_source.id},\n           filter:{in(aws.account.id, array($AccountId)) AND\n                   in(aws.region, array($Region)) AND\n                   in(dt.smartscape_source.id, iCollectArray(toSmartscapeId(array($SmartscapeId)[])))}\n\n| fieldsAdd x = arrayLast(y)\n| sort x desc\n| limit toLong($Limit)",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
        ...
        "8": {
          ...
          "description": "",
          "query": "timeseries y=avg(cloud.aws.ecs_containerinsights.MemoryReserved.By.ClusterName),\n           by: {ClusterName, aws.account.id, aws.region, dt.smartscape_source.id},\n           filter:{in(aws.account.id, array($AccountId)) AND\n                   in(aws.region, array($Region)) AND\n                   in(dt.smartscape_source.id, iCollectArray(toSmartscapeId(array($SmartscapeId)[])))}\n\n| fieldsAdd x = arrayLast(y)\n| sort x desc\n| limit toLong($Limit)",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
        ...
        "9": {
          ...
          "description": "",
          "query": "timeseries y=sum(cloud.aws.ecs_containerinsights.NetworkTxBytes.By.ClusterName),\n           by: {ClusterName, aws.account.id, aws.region, dt.smartscape_source.id},\n           filter:{in(aws.account.id, array($AccountId)) AND\n                   in(aws.region, array($Region)) AND\n                   in(dt.smartscape_source.id, iCollectArray(toSmartscapeId(array($SmartscapeId)[])))}\n\n| fieldsAdd x = arrayLast(y)\n| sort x desc\n| limit toLong($Limit)",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
