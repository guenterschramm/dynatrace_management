  ...
  content   = jsonencode({
      ...
      "tiles": {
        "11": {
          ...
          "description": "Major GC collection time as a percentage of the 10-minute interval",
        ...
        "15": {
          ...
          "description": "Count of unique ActiveGate instances per network zone",
        ...
        "16": {
          ...
          "description": "Count of unique ActiveGate instances per group",
        ...
        "20": {
          ...
          "description": "Number of OneAgent modules connected to ActiveGates",
        ...
        "22": {
          ...
          "description": "Bytes sent and received between ActiveGates and connected clients",
        ...
        "30": {
          ...
          "description": "Number of REST API requests handled by ActiveGates per operation",
        ...
        "31": {
          ...
          "description": "REST API requests with HTTP status code 400 or higher",
        ...
        "32": {
          ...
          "description": "Average size in bytes of REST API requests per operation",
        ...
        "37": {
          ...
          "description": "Host or container CPU usage percentage",
          "query": "timeseries {\n  usage = avg(dt.sfm.active_gate.system.cpu_usage)\n}, by: {\n  dt.network_zone.id, dt.active_gate.group.name, dt.active_gate.id, host.name\n}\n\n\n| fieldsAdd instance= if($SplitByInstance == \"Yes\", dt.active_gate.id, else: null)\n| fieldsAdd host= if($SplitByInstance == \"Yes\", host.name, else: null)\n\n// replace null dimensions with 'default' \n| fieldsAdd networkzone = if(isNull(dt.network_zone.id), \"default\", else: dt.network_zone.id)\n| fieldsAdd group = if(isNull(dt.active_gate.group.name), \"default\", else: dt.active_gate.group.name)\n| fieldsRemove dt.network_zone.id, dt.active_gate.group.name, dt.active_gate.id, host.name\n\n// apply filtering by variables\n| filter isNull(host) or in(host, $HostName)\n| filter isNull(instance) or in(instance, {$InstanceId})\n| filter isNull(networkzone) or in(networkzone, $NetworkZone)\n| filter isNull(group) or in(group, {$Group})\n\n| summarize avg_cpu_usage = avg(usage[]), by: {timeframe,interval, host, instance, networkzone, group}",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
        ...
        "38": {
          ...
          "description": "ActiveGate JVM process CPU usage percentage",
          "query": "timeseries {\n  usage = avg(dt.sfm.active_gate.jvm.cpu_usage)\n}, by: {\n  dt.network_zone.id, dt.active_gate.group.name, dt.active_gate.id, host.name\n}\n\n\n| fieldsAdd instance= if($SplitByInstance == \"Yes\", dt.active_gate.id, else: null)\n| fieldsAdd host= if($SplitByInstance == \"Yes\", host.name, else: null)\n\n// replace null dimensions with 'default' \n| fieldsAdd networkzone = if(isNull(dt.network_zone.id), \"default\", else: dt.network_zone.id)\n| fieldsAdd group = if(isNull(dt.active_gate.group.name), \"default\", else: dt.active_gate.group.name)\n| fieldsRemove dt.network_zone.id, dt.active_gate.group.name, dt.active_gate.id, host.name\n\n// apply filtering by variables\n| filter isNull(host) or in(host, $HostName)\n| filter isNull(instance) or in(instance, {$InstanceId})\n| filter isNull(networkzone) or in(networkzone, $NetworkZone)\n| filter isNull(group) or in(group, {$Group})\n\n| summarize avg_jvm_cpu_usage = avg(usage[]), by: {timeframe,interval, host, instance, networkzone, group}",
          "querySettings": {
            "defaultSamplingRatio": 10,
            "defaultScanLimitGbytes": 500,
            "enableSampling": false,
            ...
            "unitsOverrides": [
              {
                ...
                "delimiter": false,
                "displayUnit": "percent",
                "identifier": "avg_jvm_memory_usage",
                "suffix": "",
                "unitCategory": "percentage"
              }
            ]
        ...
        "40": {
          ...
          "description": "Number of busy threads per thread pool",
        ...
        "41": {
          ...
          "description": "Queue depth per thread pool — growing queues indicate thread pool saturation",
        ...
        "48": {
          ...
          "description": "Non-zero values indicate data loss in agent-to-ActiveGate communication",
        ...
        "52": {
          ...
          "description": "Average size in bytes of REST API responses per operation",
        ...
        "53": {
          "content": "___\n\n**Need help or missing data? Use the resources below to continue troubleshooting:**\n\n* [ActiveGate overview and deployment](https://docs.dynatrace.com/docs/shortlink/activegate-landing)\n* [ActiveGate configuration documentation](https://docs.dynatrace.com/docs/ingest-from/dynatrace-activegate/configuration)\n* [ActiveGate troubleshooting documentation](https://docs.dynatrace.com/docs/setup-and-configuration/dynatrace-activegate/troubleshooting)\n* [ActiveGate self-monitoring metrics reference](https://docs.dynatrace.com/docs/ingest-from/dynatrace-activegate/activegate-sfm-metrics)\n\n*Dashboard provided by [Discovery \u0026 Coverage](https://docs.dynatrace.com/docs/shortlink/discovery-coverage-app) app. For feedback, visit the [feedback channel](https://dt-url.net/r7038g3).*",
          "type": "markdown"
        },
        "8": {
          "davis": {
          ...
          "description": "Storage volume usage percentage calculated from total and free space",
