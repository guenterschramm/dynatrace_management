resource "dynatrace_generic_types" "network_device_1" {
  name         = "network:device"
  enabled      = true
  created_by   = "com.dynatrace.extension.snmp-generic-device 3.0.5"
  display_name = "Network device"
  insert_after = "vu9U3hXa3q0AAAABACZidWlsdGluOm1vbml0b3JlZGVudGl0aWVzLmdlbmVyaWMudHlwZQAGdGVuYW50AAZ0ZW5hbnQAJDQyODhiZjMyLTcxZDAtNTRlOS1hMjQ2LWU1NzI2N2QxNjcxMr7vVN4V2t6t"
  rules {
    rule {
      icon_pattern          = "host"
