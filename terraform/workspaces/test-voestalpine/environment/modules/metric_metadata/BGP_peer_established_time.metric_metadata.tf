resource "dynatrace_metric_metadata" "BGP_peer_established_time" {
  ...
  display_name       = "BGP peer established time"
  metric_id          = "metric-com.dynatrace.extension.snmp-generic-cisco-device.bgp4.established_time"
