resource "dynatrace_metric_metadata" "Messages_Delivered_No_Ack" {
  description        = "Count of messages delivered in no-acknowledgement mode to consumers."
  display_name       = "Messages Delivered No Ack"
  metric_id          = "metric-rabbitmq.queue.messages_deliver_no_ack.count"
