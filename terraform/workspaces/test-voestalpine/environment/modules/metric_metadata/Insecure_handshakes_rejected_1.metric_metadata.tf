resource "dynatrace_metric_metadata" "Insecure_handshakes_rejected_1" {
  ...
  metric_id          = "metric-com.dynatrace.extension.f5.bigip.profile.server.ssl.stat.insecure.handshake.rejects.count"
