resource "dynatrace_metric_metadata" "Messages_Returned_Unroutable" {
  description        = "Count of messages returned to the publisher as unroutable."
  display_name       = "Messages Returned Unroutable"
  metric_id          = "metric-rabbitmq.queue.return_unroutable.count"
