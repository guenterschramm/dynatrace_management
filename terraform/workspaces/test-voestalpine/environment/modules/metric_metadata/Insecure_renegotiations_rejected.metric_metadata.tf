resource "dynatrace_metric_metadata" "Insecure_renegotiations_rejected" {
  ...
  metric_id          = "metric-com.dynatrace.extension.f5.bigip.profile.client.ssl.stat.insecure.renegotiation.rejects.count"
