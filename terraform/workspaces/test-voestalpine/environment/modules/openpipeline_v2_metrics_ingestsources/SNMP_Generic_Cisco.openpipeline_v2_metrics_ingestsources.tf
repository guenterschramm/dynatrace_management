resource "dynatrace_openpipeline_v2_metrics_ingestsources" "SNMP_Generic_Cisco" {
  ...
  static_routing {
    pipeline_id   = "vu9U3hXa3q0AAAABACZidWlsdGluOm9wZW5waXBlbGluZS5tZXRyaWNzLnBpcGVsaW5lcwAGdGVuYW50AAZ0ZW5hbnQAJDAzZTAwMTMxLTZkODUtMzMyZS05ODk1LTc2OWVlMGYzYTVmM77vVN4V2t6t"
