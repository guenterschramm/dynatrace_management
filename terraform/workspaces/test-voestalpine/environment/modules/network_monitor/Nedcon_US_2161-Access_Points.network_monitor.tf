resource "dynatrace_network_monitor" "Nedcon_US_2161-Access_Points" {
  name          = "Nedcon US 2161 - Access Points"
  description   = " "
  type          = "MULTI_PROTOCOL"
  # enabled     = true
  frequency_min = 15
  ...
  steps {
    step {
      name         = "Nedcon US 2161 - Access Points"
      request_type = "ICMP"
      target_list  = [ "10.138.152.80", "10.138.152.78", "10.138.152.79", "10.138.152.76", "10.138.152.77", "10.138.152.81", "10.138.152.82", "10.138.152.83", "10.138.152.84" ]
      properties = {
