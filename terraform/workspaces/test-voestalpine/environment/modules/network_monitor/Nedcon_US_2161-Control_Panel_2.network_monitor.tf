resource "dynatrace_network_monitor" "Nedcon_US_2161-Control_Panel_2" {
  name          = "Nedcon US 2161 - Control Panel 3"
  description   = " "
  type          = "MULTI_PROTOCOL"
  # enabled     = true
  frequency_min = 5
  ...
  steps {
    step {
      name         = "Control Panel 3 (10.138.154.133)"
      request_type = "ICMP"
      target_list  = [ "10.138.154.133" ]
      properties = {
