resource "dynatrace_endpoint_detection_rules" "environment_Built-in_HTTP_request_method_and_route" {
  enabled      = true
  insert_after = "vu9U3hXa3q0AAAABACBidWlsdGluOmVuZHBvaW50LWRldGVjdGlvbi1ydWxlcwAGdGVuYW50AAZ0ZW5hbnQAJGVmMGUzMTlhLTAxZjAtNGNlZS04NWUzLThhYmJhMDk2YTlmNr7vVN4V2t6t"
  scope        = "environment"
  rule {
