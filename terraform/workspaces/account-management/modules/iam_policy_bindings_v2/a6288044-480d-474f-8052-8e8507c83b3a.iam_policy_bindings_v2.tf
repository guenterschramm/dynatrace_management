resource "dynatrace_iam_policy_bindings_v2" "a6288044-480d-474f-8052-8e8507c83b3a" {
  # account   = ""
  ...
  policy {
    boundaries = [ "8c467c1c-07b5-45d1-8a6b-774d2f04abdd" ]
  ...
  policy {
    boundaries = [ "f6ae8a52-74e6-47b1-aedb-615594613381" ]
